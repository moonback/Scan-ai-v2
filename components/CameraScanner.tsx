      ...
      <div className="relative h-full w-full flex flex-col">
            ...
            <>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative">
                  <div className="w-64 h-40 sm:w-80 sm:h-48 border-2 border-cyan-400 rounded-2xl relative animate-glow">
                    {/* Corners */}
                  ...
                  <p className="text-center text-white text-sm sm:text-base mt-6 px-4">
        ...
        <div className="glass-header p-4 sm:p-5 border-t border-white/10 safe-area-bottom">
          <div className="flex gap-3 max-w-md mx-auto">
            <button
              onClick={handleManualInput}
              className="flex-1 glass-input text-white font-semibold py-4 px-6 rounded-xl sm:rounded-2xl hover:bg-white/10 active:bg-white/5 transition-all touch-feedback text-sm sm:text-base min-h-[56px]"
            >
              Saisir manuellement
            </button>
          </div>
