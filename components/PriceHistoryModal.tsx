...
const PriceHistoryModal: React.FC<PriceHistoryModalProps> = ({ item, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/70 backdrop-blur-md animate-fade-in">
      <div className="glass-card rounded-2xl sm:rounded-3xl p-4 sm:p-5 w-full max-w-2xl max-h-[90vh] overflow-y-auto smooth-scroll animate-bounce-in shadow-2xl border-2 border-cyan-400/20">
        {/* Header */}
        <div className="flex items-start justify-between mb-4 sm:mb-5">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-lg sm:text-xl font-bold bg-gradient-to-r from-green-400 via-emerald-400 to-green-500 bg-clip-text text-transparent">
                Historique des Prix
              </h3>
        ...
        {allEntries.length === 0 ? (
          ...
          <>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-4 sm:mb-5">
              ...
              <div className="glass-input rounded-xl p-3 text-center border-2 border-cyan-500/20">
                <div className="flex items-center justify-center gap-1 mb-1">
                  ...
                  return (
                    <div 
                      ...
                      className={`
                        ...
                        ${isLatest ? 'border-cyan-400/40 bg-cyan-500/5' : 'border-white/5'}
        ...
        <div className="mt-5 pt-4 border-t border-white/10">
          <button
            onClick={onClose}
            className="w-full glass-button text-white font-semibold py-3.5 px-4 rounded-xl transition-all touch-feedback min-h-[52px] flex items-center justify-center gap-2 shadow-lg hover:shadow-cyan-500/30"
          >
