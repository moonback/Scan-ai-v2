      ...
      <div className="flex flex-col items-center justify-center h-full p-4 sm:p-6 text-center overflow-y-auto safe-area-top safe-area-bottom smooth-scroll animate-fade-in">
        ...
        <div className="mb-5 sm:mb-6">
          <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 sm:mb-5 glass-icon rounded-2xl flex items-center justify-center shadow-lg animate-pulse-slow">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 sm:h-10 sm:w-10 text-[#d4ff4c]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 20h2a1 1 0 001-1v-2a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1z" />
            </svg>
          </div>
          <h2 className="text-2xl sm:text-3xl font-bold mb-2 text-slate-900 tracking-tight">
            Scanner un Produit
          </h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="relative">
            <input
              ...
              maxLength={13}
              className="w-full glass-input text-slate-900 placeholder-gray-500 text-center text-lg sm:text-xl p-4 sm:p-5 rounded-xl sm:rounded-2xl font-mono tracking-widest focus:ring-2 focus:ring-[#d4ff4c]/50 transition-all text-lg"
              inputMode="numeric"
              pattern="\d{13}"
              autoComplete="off"
            />
